...
class HelloServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AgeHello = channel.unary_unary(
                '/hello.HelloService/AgeHello',
                request_serializer=hello__pb2.HelloAge.SerializeToString,
                response_deserializer=hello__pb2.HelloResp.FromString,
                )
...
class HelloServiceServicer(object):
    ...
    def AgeHello(self, request, context):
...
def add_HelloServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AgeHello': grpc.unary_unary_rpc_method_handler(
                    servicer.AgeHello,
                    request_deserializer=hello__pb2.HelloAge.FromString,
                    response_serializer=hello__pb2.HelloResp.SerializeToString,
            ),
    }
...
class HelloService(object):
    ...
    def AgeHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hello.HelloService/AgeHello',
            hello__pb2.HelloAge.SerializeToString,
            hello__pb2.HelloResp.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
